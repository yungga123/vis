        ...
        function (res) {
            $.each(res, function (key, value) {
                if (value.status == "10.00%") {
                    ...
                    $(".post").append(
                        "<p>Updated On: " + value.created_at + "</p>"
                    );
                    $(".post").append(
                        "<p>Remark Next Step: " +
                            value.remark_next_step +
                            "</p>"
                    );
                }
                ...
                if (value.status == "50.00%") {
                    $(".post").append(
                        "<h3>Status: DEVELOPED SOLUTION (50%)</h3>"
                    );
                    $(".post").append(
                        "<p>Updated On: " + value.created_at + "</p>"
                    );
                ...
                if (value.status == "70.00%") {
                    ...
                    $(".post").append(
                        "<p>Forecast Close Date: " +
                            value.forecast_close_date +
                            "</p>"
                    );
                    $(".post").append(
