...
class Overtime extends BaseController
{
        ...
        $response   = $this->customTryCatch(
            ...
            function($data) {
                ...
                $inputs         = [
                    ...
                    'total_hours'   => $this->_getTotalHours($request['time_start'], $request['time_end']),
     ...
     * @return double
     */
    private function _getTotalHours($time_start, $time_end)
    {
        $total_hours = 0;
        ...
        if (! empty($time_start) && ! empty($time_end)) {
            ...
            $timeDifference = $time_end->getTimestamp() - $time_start->getTimestamp();

            // Convert seconds to hours
            $total_hours = $timeDifference / 3600;
