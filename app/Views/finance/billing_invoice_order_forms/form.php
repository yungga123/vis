...
<div class="modal fade" id="billing_invoice_order_forms_modal" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form id="billing_invoice_order_forms_form" class="with-label-indicator" action="<?= url_to('finance.billing_invoice_order_forms.save'); ?>" method="post" autocomplete="off">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="callout callout-info">
                        <strong>Note:</strong>
                        If not empty, initial dropdowns of <strong>Order Form</strong> are by 10. Type the <strong>(ID | Client | Client Branch)</strong> to search if not in the options and then, click to select.
                    </div>
                    <div class="form-group">
                        <label class="required mb-0" for="order_form_id">Order Form</label>
                        <div>Format: ID | Client | Client Branch</div>
                        <select class="custom-select" name="order_form_id" id="order_form_id" style="width: 100%;"></select required>
                        <div id="orig_order_form"></div>
                        <small id="alert_order_form_id" class="text-danger"></small>
                    </div>
                    <div class="form-group order_form">
