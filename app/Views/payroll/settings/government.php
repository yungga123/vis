            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="required" for="sss_salary_range_min">Minimum Salary Range Amount</label>
                                ...
                                <div class="text-sm mt-1">The staring range of the compensation (Ex. Below - 4,250).</div>
                            </div>
                            <div class="form-group">
                                <label class="required" for="sss_salary_range_max">Maximum Salary Range Amount</label>
                                ...
                                <div class="text-sm mt-1">The last range of the compensation (Ex. 29,750 - Over).</div>
                            </div>
                            <div class="form-group">
                                <label class="required" for="sss_starting_msc">Starting MSC Regular SS/EC Amount</label>
                                ...
                                <div class="text-sm mt-1">The starting Monthly Salary Credit (MSC) (Ex. 4,000).</div>
                            </div>
                            <div class="form-group">
                                <label class="required" for="sss_last_msc">Last MSC Regular SS/EC Amount</label>
                                ...
                                <div class="text-sm mt-1">The last Monthly Salary Credit (MSC) (Ex. 20,000).</div>
                            </div>
                            <div class="form-group">
                                <label class="required" for="sss_next_diff_amount">Diff to Next Range/Total Amount</label>
                                <input type="number" name="sss_next_diff_amount" id="sss_next_diff_amount" class="form-control" placeholder="Ex. 500" step="00.01">
                                <small id="alert_sss_next_diff_amount" class="text-danger"></small>
                                <div class="text-sm mt-1">The amount difference to the next range of compensation (Ex. 500).</div>
                            </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label class="required" for="pagibig_contri_rate_employeer">Contribution Rate Employeer %</label>
                            ...
                            <div class="form-group">
                                <label class="required" for="pagibig_contri_rate_employee">Contribution Rate Employee %</label>
