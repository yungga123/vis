...
<div class="container-fluid">
    <?= $this->include('settings/mail_config/mail_list') ?>
        ...
        <div class="accordion" id="accordion">
            <div class="card card-danger">
                <div class="card-header" id="headingOne">
                    <h2 class="mb-0">
                        <button class="btn btn-link btn-block text-left text-white text-bold" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            Mail Configurations
                        </button>
                    </h2>
                </div>
