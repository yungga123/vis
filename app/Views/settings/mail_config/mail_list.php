    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p>
                    <strong>Note:</strong>
                    In <strong>Email Received</strong>, if multiple emails - separate it by comma (e.g. mail@email.com, mail2@email.com). <br>
                </p>
                    ...
                    <table id="mail_list_table" class="table table-hover table-striped nowrap align-items-middle" width="100%">
                        <thead class="nowrap">
                            <tr>
                                <th>Module Name</th>
                                <?php if (is_developer()): ?>
                                    <th>Sent Email Notification?</th>
                                    <th>Enable Email Notification?</th>
                                <?php endif; ?>
                                <th width="50%">Email Received</th>
