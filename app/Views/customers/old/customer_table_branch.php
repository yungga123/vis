      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <form method='get' action="customers-list" id="searchForm">
        ...
        <div class="card-body">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              <?php foreach ($customersViewModel as $item) : ?>
                        ...
                        <div class="card p-0">
                          ...
                          <div class="card-body">
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                <?php foreach ($customer_find = $customerBranchViewModel->where('customer_id', $item['id'])->findAll() as $item_branch) : ?>
