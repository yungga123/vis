                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="customer_id" id="customer_id">
                                    ...
                                    <?php foreach ($customersvt as $customer) : ?>
...
<?= ($uri->getSegment(1)=='add_customervtbranch') ? $this->include('customers_vt/add_customervtbranch_script') : "" ;?>
<?= ($uri->getSegment(1)=='edit-customervtbranch') ? $this->include('customers_vt/edit_customervtbranch_script') : "" ;?>
<?= $this->endSection() ;?>
