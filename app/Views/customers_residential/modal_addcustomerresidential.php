                                ...
                                <div class="card-body row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <small id="alert_forecast" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small id="alert_customer_name" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small id="alert_contact_person" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small id="alert_notes" class="form-text text-muted"></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <small id="alert_contact_number" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card-body row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <small id="alert_address_province" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small id="alert_address_city" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small id="alert_address_brgy" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <small id="alert_address_sub" class="form-text text-muted"></small>
                                        </div>
                                    </div>
